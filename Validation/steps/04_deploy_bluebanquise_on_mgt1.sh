...
scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r inventory bluebanquise@$mgt1_ip:/home/bluebanquise/
...
cd bluebanquise
cp -a ../inventory resources/examples/validation
