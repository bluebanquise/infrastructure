...
if [ "$1" == "all" ]; then
podman run -it --rm -v ~/build/debian11/x86_64/:/root/debbuild/DEBS debian_11_build nyancat Debian 11
#podman run -it --rm -v ~/build/debian11/x86_64/:/root/debbuild/DEBS debian_11_build prometheus Debian 11
