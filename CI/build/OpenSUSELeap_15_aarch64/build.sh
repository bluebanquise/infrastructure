...
if [ "$1" == "all" ]; then
podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp opensuse_leap_15_build nyancat opensuse_leap 15
#podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp opensuse_leap_15_build conman opensuse_leap 15
...
podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp opensuse_leap_15_build loki opensuse_leap 15
podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp opensuse_leap_15_build clonezilla opensuse_leap 15
podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp opensuse_leap_15_build alpine opensuse_leap 15

else
podman run -it --rm -v ~/build/lp15/aarch64/:/usr/src/packages/RPMS/ -v ~/build/lp15/sources/:/usr/src/packages/SRPMS/ -v /tmp:/tmp  opensuse_leap_15_build $1 opensuse_leap 15
fi
