...
podman run -it --rm -v ~/build/debian11/arm64/:/root/debbuild/DEBS -v /tmp:/tmp debian_11_build atftp Debian 11
...
podman run -it --rm -v ~/build/debian11/arm64/:/root/debbuild/DEBS -v /tmp:/tmp debian_11_build loki Debian 11
podman run -it --rm -v ~/build/debian11/arm64/:/root/debbuild/DEBS -v /tmp:/tmp debian_11_build clonezilla Debian 11
podman run -it --rm -v ~/build/debian11/arm64/:/root/debbuild/DEBS -v /tmp:/tmp debian_11_build alpine Debian 11
else
