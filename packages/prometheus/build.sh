...
rpmbuild -ta prometheus-$prometheus_version.linux-$prometheus_arch.tar.gz --define "_software_version $prometheus_version" --define "_software_architecture $prometheus_arch"
sleep 20
...
rpmbuild -ta alertmanager-$alertmanager_version.linux-$prometheus_arch.tar.gz --define "_software_version $alertmanager_version" --define "_software_architecture $prometheus_arch"
sleep 20
...
rpmbuild -ta node_exporter-$node_exporter_version.linux-$prometheus_arch.tar.gz --define "_software_version $node_exporter_version" --define "_software_architecture $prometheus_arch"
sleep 20
...
rpmbuild -ta ipmi_exporter-$ipmi_exporter_version.linux-$prometheus_arch.tar.gz --define "_software_version $ipmi_exporter_version" --define "_software_architecture $prometheus_arch"
sleep 20
...
rpmbuild -ta snmp_exporter-$snmp_exporter_version.linux-$prometheus_arch.tar.gz --define "_software_version $snmp_exporter_version" --define "_software_architecture $prometheus_arch"
sleep 20
...
rpmbuild -ta karma-linux-$prometheus_arch.tar.gz --define "_software_version $karma_version" --define "_software_architecture $prometheus_arch"
