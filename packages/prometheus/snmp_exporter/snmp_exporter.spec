...
Source:   https://github.com/prometheus/snmp_exporter/releases/download/v%{_software_version}/prometheus-snmp_exporter-%{_software_version}.linux-%{_software_architecture}.tar.gz
