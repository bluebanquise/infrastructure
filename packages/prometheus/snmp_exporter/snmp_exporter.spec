...
wget --timeout=10 --tries=5 --retry-connrefused --waitretry=30 https://github.com/prometheus/snmp_exporter/releases/download/v%{_software_version}/snmp_exporter-%{_software_version}.linux-amd64.tar.gz
