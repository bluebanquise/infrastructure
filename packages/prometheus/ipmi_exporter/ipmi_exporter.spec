...
Summary:  prometheus-ipmi-exporter
Release:  1%{?dist}
Version:  %{_software_version}
License:  apache-2.0
Group:    System Environment/Base
Source:   https://github.com/soundcloud/ipmi_exporter/releases/download/v%{_software_version}/prometheus-ipmi-exporter-%{_software_version}.linux-%{_software_architecture}.tar.gz
...
cp -a ipmi_exporter-%{_software_version}.linux-%{_software_architecture}/ipmi_exporter $RPM_BUILD_ROOT/usr/bin/
