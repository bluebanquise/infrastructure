...
Source:   https://github.com/prometheus/prometheus/releases/download/v2.20.1/prometheus-2.19.2.tar.gz
...
cp -a prometheus-2.20.1.linux-amd64/prometheus $RPM_BUILD_ROOT/usr/local/bin/
cp -a prometheus-2.20.1.linux-amd64/promtool $RPM_BUILD_ROOT/usr/local/bin/
